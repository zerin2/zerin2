...
- [Телеграм-бот Public Quest](https://github.com/zerin2/public_quest_bot) — Игра-квест в Telegram в формате интерактивного сценария. Бот реализует сцену приветствия, пользовательский ввод, переходы между сценами и хранение данных.Поддерживается различная логика прохождения с динамическими клавиатурами и условиями.
Стек: Python, Aiogram 3, Redis, FSM-состояния, Pydantic.
- [REST API для сервиса отзывов]() — API с регистрацией, аутентификацией и возможностью оставлять отзывы и комментарии на произведения.
- [Микросервис управления очередью сообщений]() — Асинхронный микросервис на Django и Dramatiq для организации отправки сообщений.
