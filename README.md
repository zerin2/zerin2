...
Работал с FastAPI, Django, DRF, Docker, Redis и различными библиотеками для работы с очередями сообщений, активно развиваюсь в области деплоя и контейнеризации приложений.
---
### 🛠️ Tech Stack:
