...
- [Телеграм-бот Public Quest](https://github.com/zerin2/public_quest_bot) — Игра-квест в Telegram в формате интерактивного сценария. Бот реализует сцену приветствия, пользовательский ввод, переходы между сценами и хранение данных.
